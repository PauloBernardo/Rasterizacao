...
def draw_camera_and_vectors_in_world(ponto_camera, vetor_up, vetor_n, vetor_u, vetor_v, cube, pyramid, parallel, tronco):
    camera = np.array(
        [
...
def q3(cube, pyramid, parallel, tronco):
    ...
    V = np.matrix([
        [vetor_u[0], vetor_u[1], vetor_u[2], - ponto_camera[0] * vetor_u[0] - ponto_camera[1] * vetor_u[1] - ponto_camera[2] * vetor_u[2]],
        [vetor_v[0], vetor_v[1], vetor_v[2], - ponto_camera[0] * vetor_v[0] - ponto_camera[1] * vetor_v[1] - ponto_camera[2] * vetor_v[2]],
        [vetor_n[0], vetor_n[1], vetor_n[2], - ponto_camera[0] * vetor_n[0] - ponto_camera[1] * vetor_n[1] - ponto_camera[2] * vetor_n[2]],
        [0, 0, 0, 1]
    ])
